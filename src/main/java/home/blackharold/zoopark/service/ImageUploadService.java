...
import home.blackharold.zoopark.exceptions.ImageNotFoundException;
import home.blackharold.zoopark.repository.ImageRepository;
...
@Service
public class ImageUploadService implements UserFromPrincipal {
    ...
    private <T> Collector<T, ?, T> checkSinglePost() {
